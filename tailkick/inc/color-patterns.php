 ...
 */
function tailkick_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filters TailKick default saturation level.
	 *
	 * @since TailKick 0.1
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation         = absint( apply_filters( 'tailkick_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.tailkick-front-page) .entry-title,
...
.colors-custom .tailkick-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.tailkick-front-page .panel-content .recent-posts article,
...
.colors-custom.tailkick-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters TailKick custom colors CSS.
	 *
	 * @since TailKick 0.1
	 *
	 ...
	 */
	return apply_filters( 'tailkick_custom_colors_css', $css, $hue, $saturation );
}
