...
<section class="mx-auto max-w-6xl w-full flex flex-col md:flex-row justify-between px-1 xs:px-4 xl:px-0 py-6 md:py-14 space-y-6 md:space-y-0 md:space-x-16" id="showcase_panel">
  <div class="flex flex-col xs:flex-row md:flex-col justify-center items-center md:items-start align-middle">
    ...
    <div class="ml-0 xs:ml-6 md:ml-0">
      <h3 class="mt-3 font-bold text-3xl text-center xs:text-left md:text-center"><?php echo get_theme_mod('showcase_box1_heading', 'Show It'); ?></h3>
  ...
  <div class="flex flex-col xs:flex-row md:flex-col justify-center items-center md:items-start align-middle">
    ...
    <div class="ml-0 xs:ml-6 md:ml-0">
      <h3 class="mt-3 font-bold text-3xl text-center xs:text-left md:text-center"><?php echo get_theme_mod('showcase_box2_heading', 'Sing It'); ?></h3>
  ...
  <div class="flex flex-col xs:flex-row md:flex-col justify-center items-center md:items-start align-middle">
    ...
    <div class="ml-0 xs:ml-6 md:ml-0">
      <h3 class="mt-3 font-bold text-3xl text-center xs:text-left md:text-center"><?php echo get_theme_mod('showcase_box3_heading', 'Share It'); ?></h3>
