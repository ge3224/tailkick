...
<section class="mx-auto max-w-6xl w-full flex flex-col md:flex-row justify-between px-1 xs:px-4 xl:px-0 py-6 md:py-14 space-y-6 md:space-y-0 md:space-x-16 rtl:gap-16" id="showcase_panel">
  ...
  <div class="flex flex-col xs:flex-row md:flex-col justify-center items-center md:items-start gap-3 align-middle">
    <div class="xs:flex-shrink-0 w-24 md:w-28 mx-auto">
